...
module.exports = function (api) {
  api.loadSource(({ addMetadata, addCollection }) => {
    ...
    addMetadata(
      'siteTitle',
      process.env.SITE_TITLE || 'Developer MarTech Guide, Tips, HowTo, Coding etc.'
    )
    addMetadata('siteAuthor', process.env.SITE_AUTHOR || 'Matt Ondo')
    addMetadata(
      'siteAuthorUrl',
      process.env.SITE_AUTHOR_URL || 'https://mattondo.io/'
    )
    addMetadata(
      'archive_title',
